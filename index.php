...
<head>
	...
	<title>Home | Karya Utama Mebel</title>
					...
					<div class="col-sm-3">
						...
						<div class="col-sm-9 padding-right">
							<div class="features_items" ><!--features_items-->
								...
								if(isset($_GET['cari'])){
									$cari = $_GET['cari'];
									$ambil = $koneksi->query("SELECT * FROM tb_produk WHERE nama_produk LIKE '%".$cari."%'");		
								}else{
							...
							<div class="recommended_items"><!--recommended_items-->
								<h2 class="title text-center" style="color:#2B6BB9;">recommended items</h2>
