...
<head>
	...
	<title>Product Details | Utama Karya Mebel</title>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-2">
				<img src="images/<?php echo $detail['foto_produk']; ?>" class="img-responsive">
			</div>
			<div class="col-md-4">
				...
				<form method="POST">
					<div class="form-group">
						<div class="input-group">
							<input type="number" min="1" name="jumlah" class="form-control" required max="<?php echo $detail['stok'] ?>">
							<div class="input-group-btn">
								<button class="btn btn-default checkout" name="beli">Beli</button>
							</div>
						</div>
					</div>
				</form>
				...
				if (isset($_POST['beli'])) {
					//mendapatkan id_produk yang dibeli
					$jumlah = $_POST['jumlah'];
